...
namespace GeeksCoreLibrary.Modules.Exports.Interfaces
{
    public interface IExcelService
    {
        ...
        /// <param name="fileStream">Optional: The stream of the file</param>
        /// <returns></returns>
        List<string> GetColumnNames(string filePath, Stream fileStream = null);
        ...
        /// /// <param name="fileStream">Optional: The stream of the file</param>
        /// <returns></returns>
        int GetRowCount(string filePath, Stream fileStream = null);
        ...
        /// <param name="fileStream">Optional: The stream of the file</param>
        /// <returns></returns>
        List<List<string>> GetLines(string filePath, int numberOfColumns, bool skipFirstLine = false, bool firstColumnAreIds = false, Stream fileStream = null);
    }
}
